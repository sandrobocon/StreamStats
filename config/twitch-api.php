...
return [
     ...
     */
    'client_id' => env('TWITCH_HELIX_KEY', env('TWITCH_CLIENT_ID')),

    /*
     * The Client Secret to use for OAuth requests.
     */
    'client_secret' => env('TWITCH_HELIX_SECRET', env('TWITCH_CLIENT_SECRET')),

    /*
     * The Redirect URI to use for generating OAuth authorization.
     */
    'redirect_url' => env('TWITCH_HELIX_REDIRECT_URI', env('TWITCH_REDIRECT_URI')),
